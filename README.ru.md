...
| | Подогнано по | n | Проверенная ошибка |
|---|---|---|---|
| **Квазичастичная щель** — фотоэмиссия, транспорт | HSE06 из JARVIS dft_2d | 32 | **0.19 эВ** leave-one-out |
| **Оптическая щель** — край поглощения | G₀W₀ − экситон BSE, из C2DB | 184 | **0.38 эВ** 10-кратная CV |
...
**Оптическая была слабым местом, и её перестроили.** Раньше она опиралась на пять
...
**Опровержение.** Раньше здесь утверждалось, что разность двух поправок — это энергия
связи экситона, 0.55 эВ на TMD, как в литературе. Согласие было круговым: обе подгонки
обучались на этих же четырёх материалах. После переноса оптической поправки на 184
материала разность падает до ~0.3 эВ на TMD, тогда как BSE даёт 0.5, — так вывод и
поймали. Поправки привязаны к **разным** эталонам, HSE06 против G₀W₀ − экситон, а сам
HSE06 идёт примерно на 0.4 эВ ниже G₀W₀ при щели 1.7 эВ, поэтому их разность смешивает
экситон с этим расхождением. Энергия связи теперь берётся прямо из BSE: медиана
**0.29 от щели** с разбросом 0.08 по тем же 184 материалам — там же, где сидит
известный скейлинг E_g/4 для 2D.
