...
|---|---|---|---|
| **Квазичастичная щель** — фотоэмиссия, транспорт | G₀W₀ из C2DB | 184 | **0.25 эВ** |
| **Энергия связи экситона** | Бете–Солпитер из C2DB | 184 | **0.14 эВ** |
...
|---|---|---|
| Квазичастичная щель (G₀W₀) | 0.42 | **0.25** |
| Энергия связи (BSE) | 0.23 | **0.14** |
| Оптическая щель | 0.38 | **0.22** |
