...
1. Предпосчитанные предсказания по всем открытым 2D-структурам, чтобы типичный
   сценарий вообще не требовал загрузки файла.
2. Обозреватель поверх этой таблицы: фильтр по элементам, диапазону щели и вердикту.
